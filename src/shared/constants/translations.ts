const RU = {
  ...
  LOGIN: {
    TITLE: "Авторизация",
    LOGIN_DESCRIPTION: "Войдите в аккаунт Gerbarium, чтобы продолжить.",
    REGISTER_DESCRIPTION:
      "Создайте аккаунт, затем подтвердите email шестизначным кодом.",
    REGISTER_STEP_ACCOUNT: "Данные аккаунта",
    REGISTER_STEP_PASSWORD: "Защита аккаунта",
    REGISTER_NEXT: "Далее",
    REGISTER_BACK: "Назад",
    ...
    RESEND_BUTTON: "Отправить код снова",
    RESEND_IN: (seconds: number) => `Повторная отправка через ${seconds}с`,
    RESEND_HINT: "Не получили письмо? Запросите новый код.",
    EMAIL_SENT_NOTICE: "Письмо с кодом подтверждения отправлено.",
    USE_ANOTHER_ACCOUNT: "Войти под другим аккаунтом",
    DEV_CODE_LABEL: "DEV",
  ...
  STORE_ERRORS: {
    ...
    AUTH_EMAIL_CODE_INVALID: "Введите корректный шестизначный код",
    AUTH_EMAIL_ALREADY_VERIFIED: "Email уже подтвержден",
    AUTH_VERIFY_EMAIL: "Не удалось подтвердить email",
    AUTH_RESEND_EMAIL: "Не удалось отправить код повторно",
    AUTH_EMAIL_STATUS: "Не удалось обновить статус подтверждения email",
    AUTH_UNAUTHORIZED: "Сессия истекла. Войдите заново",
  },
};
...
const EN = {
  ...
  LOGIN: {
    ...
    LOGIN_DESCRIPTION: "Sign in to your Gerbarium account to continue.",
    REGISTER_DESCRIPTION:
      "Create an account, then confirm your email with a six-digit code.",
    REGISTER_STEP_ACCOUNT: "Account details",
    REGISTER_STEP_PASSWORD: "Account security",
    REGISTER_NEXT: "Next",
    REGISTER_BACK: "Back",
    ...
    RESEND_HINT: "Didn't get the email? Request another code.",
    EMAIL_SENT_NOTICE: "Verification email sent successfully.",
  ...
  STORE_ERRORS: {
    ...
    AUTH_EMAIL_CODE_INVALID: "Enter a valid six-digit verification code",
    AUTH_EMAIL_ALREADY_VERIFIED: "Email is already verified",
    AUTH_VERIFY_EMAIL: "Failed to verify email",
    AUTH_RESEND_EMAIL: "Failed to resend verification code",
    AUTH_EMAIL_STATUS: "Failed to refresh email verification status",

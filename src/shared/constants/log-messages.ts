...
export const LOG_MESSAGES = {
  ...
  AUTH_LOGIN_OFFLINE_ATTEMPT: '[AUTH] Local login attempt:',
  AUTH_LOGIN_OFFLINE_SUCCESS: '[AUTH] Local login success:',
  AUTH_LOGIN_OFFLINE_FAILED: '[AUTH] Local login failed:',
...
export const UI_MESSAGES = {
  ...
  LOGIN_SUBMIT: 'Вход',
  LOGIN_OFFLINE_MODE: 'Резервный вход',

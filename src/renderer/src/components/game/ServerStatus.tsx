...
export function ServerStatus({ 
  ...
  if (isLoading) {
    return (
      <div className="flex items-center gap-2 text-theme-muted text-xs font-minecraft">
        <div className="w-2 h-2 bg-theme-muted animate-pulse rounded-full" />
  ...
  if (error || !status) {
    return (
      <div className="flex items-center gap-2 text-[var(--mc-error-text)] text-xs font-minecraft">
        <div className="w-2 h-2 bg-[var(--mc-error-text)] rounded-full" />
  ...
  return (
    <div className="flex items-center gap-3 mc-card px-4 py-2">
      {/* Status Indicator */}
      <div className="flex items-center gap-2">
        ...
        />
        <span className="text-theme text-xs font-minecraft">
      ...
      {/* Player Count */}
      {status.online && (
        <div className="flex items-center gap-2 text-[var(--mc-progress-fill-a)] text-xs font-minecraft">
      ...
      {/* Version */}
      {status.version && (
        <span className="text-theme-muted text-xs font-minecraft hidden sm:inline">
          v{status.version}
        </span>
      )}
    </div>

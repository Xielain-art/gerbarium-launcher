              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <label className="flex cursor-pointer items-center gap-3">
                    ...
                    <span className="font-minecraft text-sm text-[#e0e0e0]">
                      Показывать статус в Discord (RPC)
                    </span>
                  </label>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  {(javaLoading ||
                    ...
                    >
                      {isDownloadingJava
                        ? `${javaStatus === "EXTRACTING" ? "Распаковка..." : "Загрузка: " + javaProgress + "%"}`
                        : javaLoading
                          ? "Поиск..."
                          : javaError
                            ? javaError
                            : `Найдена версия: ${javaVersion}`}
                    </p>
                  )}
                  {isDownloadingJava && (
          ...
          <div className="relative mx-4 max-w-md rounded border-[4px] border-t-[#5a5a5a] border-l-[#5a5a5a] border-b-[#1a1a1a] border-r-[#1a1a1a] bg-[#2b2d31] shadow-2xl">
            ...
            <div className="p-6">
              <p className="font-minecraft text-sm text-[#e0e0e0]">
                Вы уверены, что хотите сбросить все настройки до значений по
                умолчанию? Это действие нельзя отменить.
              </p>
            </div>

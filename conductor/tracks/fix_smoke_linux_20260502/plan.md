...
- [x] Task: Reproduction - Confirm safeStorage limitation in Linux CI [0236152]
    - [x] Create and run a minimal script to check `safeStorage.isEncryptionAvailable()` in xvfb

...
- `verifyJREChecksum()` --calls--> `calculateFileSha256()`  [INFERRED]
  src/main/handlers/javaHandler.ts → src/main/utils/integrity.ts
- `useAdminScreen()` --calls--> `useTranslation()`  [INFERRED]
...
Cohesion: 0.08
Nodes (36): useAdminChangelogMutations(), useAdminChangelogQuery(), useAdminNewsMutations(), useAdminNewsQuery(), useAdminNewsTagsQuery(), useAdminRolesQuery(), useAdminStatsQuery(), useAdminUserMutations() (+28 more)

### Community 2 - "Community 2"
Cohesion: 0.08
Nodes (43): asyncSystemScan(), digestMessage(), displayArticle(), dlAsync(), downloadJava(), initNews(), loadNews(), refreshServerStatus() (+35 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (42): bindAuthAccountLogOut(), bindAuthAccountSelect(), bindDropinModFileSystemButton(), bindDropinModsRemoveButton(), bindMinMaxRam(), bindModsToggleSwitch(), bindRangeSlider(), bindShaderpackButton() (+34 more)
...
Cohesion: 0.15
Nodes (3): AdminDialogs(), AdminDialogShell(), RolesDialog()

### Community 14 - "Community 14"
Cohesion: 0.42
Nodes (10): calculateFileSha256(), extractAsarSha256FromLatestYml(), fetchExpectedAsarSha256(), getLatestYmlFilename(), isHexHash(), isSimpleYamlComment(), normalizeHexHash(), parseSimpleYamlKeyValue() (+2 more)
...
Cohesion: 0.18
Nodes (11): src/renderer/src/components/settings/JavaSettingsTab.tsx, src/renderer/src/components/settings/ProfileSettingsTab.tsx, src/renderer/src/components/settings/SettingsActionBar.tsx, src/renderer/src/components/settings/SettingsHeader.tsx, src/renderer/src/components/settings/SettingsTabNav.tsx, src/renderer/src/components/settings/SupportSettingsTab.tsx, src/renderer/src/components/settings/java/JavaInstalledList.tsx, src/renderer/src/components/settings/java/JavaJvmArgsSection.tsx (+3 more)

### Community 18 - "Community 18"
Cohesion: 0.25
Nodes (11): src/renderer/src/components/shadcn/index.ts, src/renderer/src/components/shadcn/ui/badge.tsx, src/renderer/src/components/shadcn/ui/button.tsx, src/renderer/src/components/shadcn/ui/card.tsx, src/renderer/src/components/shadcn/ui/checkbox.tsx, src/renderer/src/components/shadcn/ui/dialog.tsx, src/renderer/src/components/shadcn/ui/index.ts, src/renderer/src/components/shadcn/ui/input.tsx (+3 more)
...
Cohesion: 0.73
Nodes (4): mapApiNews(), normalizeTags(), resolveCategoryFromTags(), stripHtml()

### Community 35 - "Community 35"
Cohesion: 0.6
Nodes (4): defaultJavaConfig(), defaultJavaConfig17(), defaultJavaConfig8(), resolveSelectedRAM()

### Community 36 - "Community 36"
Cohesion: 0.33
Nodes (6): src/renderer/src/components/ui/Input.tsx:Input, src/renderer/src/hooks/useDashboardScreen.ts:useDashboardScreen, src/renderer/src/hooks/useJava.ts:useJava, src/renderer/src/hooks/useLoginScreen.ts:useLoginScreen, src/renderer/src/hooks/useSettingsScreen.tsx:useSettingsScreen, src/renderer/src/hooks/useTranslation.ts:useTranslation
...
Cohesion: 0.4
Nodes (3): Vite, src/renderer/README.md, src/renderer/assets/vite.svg

### Community 44 - "Community 44"
Cohesion: 0.83
Nodes (3): bootstrapElectron(), isServerReady(), wait()

### Community 49 - "Community 49"
Cohesion: 0.5
Nodes (4): AdminNewsTab, NewsFormSubTab, NewsListSubTab, NewsTagsSubTab

### Community 50 - "Community 50"
Cohesion: 0.5
Nodes (4): NewsPreviewModal, ChangelogPreviewModal, DashboardContentDialog, src/renderer/src/components/dashboard/NewsPreviewModal.tsx
...
- **Are the 28 inferred relationships involving `buildApiResult()` (e.g. with `getUsersRequest()` and `banUserRequest()`) actually correct?**
  _`buildApiResult()` has 28 INFERRED edges - model-reasoned connections that need verification._
